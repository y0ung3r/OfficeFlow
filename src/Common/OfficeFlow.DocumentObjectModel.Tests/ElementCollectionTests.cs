...
namespace OfficeFlow.DocumentObjectModel.Tests
{
    ...
    {
        private readonly ElementCollection _sut
        ...
        private readonly FakeElement _fourth
            = new FakeElement();

        private readonly FakeElement _tail
            = new FakeElement();

        private readonly FakeElement _detached
            = new FakeElement();
        ...
        public void Should_throws_exception_while_removing_nonexistent_element(int index)
        {
            ...
            // Act & Assert
            new Action(() => _sut.RemoveAt(index))
                .Should()
        ...
        public void Should_throws_exception_if_attempts_insert_element_to_out_of_the_range(int index)
        {
            ...
            // Act & Assert
            new Action(() => _sut.Insert(index, _second))
                .Should()
